    ...
    <div class="mdl-grid f028HL">
        <div class="demo-card-square mdl-card mdl-shadow--2dp mdl-cell--8-col mdl-grid-8">
            <div class="mdl-card__title mdl-card--expand" style="background:#FF9800;">
                <h2 class="mdl-card__title-text"><?php echo translate("Istoric recomandări - " . getUserData($patient), "Recomandations historic - " . getUserData($patient)); ?><i class="material-icons" style="opacity: 0.3;font-size: 380%;position: absolute;top: -6px;right: 0;">thumb_up</i></h2>
            </div>
                ...
                <table class="mdl-data-table mdl-js-data-table  mdl-shadow--2dp" style="width:100%">
                  <thead>
                    <tr>
                      ...
                      <th class="mdl-data-table__cell--non-numeric">Recomandare</th>
