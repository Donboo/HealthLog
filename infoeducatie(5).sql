...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 30, 2017 at 01:01 PM
...
CREATE TABLE `web_accounts` (
  `ID` int(11) NOT NULL,
  `Name` varchar(128) COLLATE utf8_romanian_ci NOT NULL COMMENT 'Surname, Prename',
  `Password` varchar(256) CHARACTER SET latin1 NOT NULL,
  `CardCode` bigint(20) NOT NULL,
  `EMail` varchar(128) CHARACTER SET latin1 NOT NULL,
  `Location` varchar(256) COLLATE utf8_romanian_ci NOT NULL COMMENT 'AREA(0 if no one), CITY, COUNTY',
  `Since` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `AccountType` int(1) NOT NULL,
  `BirthYear` int(11) NOT NULL,
  `Blind` int(11) NOT NULL COMMENT '0 NO / 1 YES'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_romanian_ci ROW_FORMAT=COMPACT;

--
-- Dumping data for table `web_accounts`
--

INSERT INTO `web_accounts` (`ID`, `Name`, `Password`, `CardCode`, `EMail`, `Location`, `Since`, `AccountType`, `BirthYear`, `Blind`) VALUES
(1, 'Pătrașcu Andrei', 'E4757E322865FE5F7DF366BDD14FA9DE208907EE5CEE690550349D5E300D1ACD', 3276798432475544591, 'donbooo@yahooo.com', '0, FOCȘANI, VRANCEA', '2017-07-27 18:45:59', 1, 2001, 0),
(2, 'Gigel Ionel', 'E4757E322865FE5F7DF366BDD14FA9DE208907EE5CEE690550349D5E300D1ACD', 4276798432475544592, 'gigel@yahoo.com', '0, PLOIEȘTI, PRAHOVA', '2017-07-27 18:48:29', 1, 1973, 0);
...
(8, '3276798432475544591', '2017-07-25', 0);
...
CREATE TABLE `web_diagnostics` (
  `ID` int(11) NOT NULL,
  `CardCode` varchar(128) CHARACTER SET latin1 NOT NULL,
  `Diagnostic` varchar(512) CHARACTER SET latin1 NOT NULL,
  `Hospital` int(11) NOT NULL,
  `DoctorCode` varchar(128) CHARACTER SET latin1 NOT NULL,
  `Date` varchar(128) CHARACTER SET latin1 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_romanian_ci ROW_FORMAT=COMPACT;
...
CREATE TABLE `web_healthguide` (
  `ID` int(11) NOT NULL,
  `TitleRO` varchar(128) COLLATE utf8_romanian_ci NOT NULL,
  `TitleEN` varchar(128) COLLATE utf8_romanian_ci NOT NULL,
  `Photo` varchar(128) CHARACTER SET latin1 NOT NULL,
  `Content` longtext COLLATE utf8_romanian_ci NOT NULL,
  `ContentEN` longtext COLLATE utf8_romanian_ci NOT NULL,
  `Date` varchar(128) CHARACTER SET latin1 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_romanian_ci ROW_FORMAT=COMPACT;
...
(6, 'Aloe Vera', 'Aloe Vera', 'aloe-vera-625_625x350_71443086188.jpg', '<p><em><strong>Aloe vera</strong></em> este o specie de <a href=\"https://ro.wikipedia.org/wiki/Plantă_suculentă\">plante suculente</a> care este probabil originară din nordul <a href=\"https://ro.wikipedia.org/wiki/Africa\">Africii</a>. Specia nu prezintă populații naturale, deși alte <em><a href=\"https://ro.wikipedia.org/wiki/Aloe\">aloe</a></em> sunt prezente în <a href=\"https://ro.wikipedia.org/wiki/Africa_de_nord\">Africa de nord</a>.\"<a href=\"https://ro.wikipedia.org/wiki/Aloe_vera#cite_note-Akinyele-1\">[1]</a> Specia este adesea folosită în <a href=\"https://ro.wikipedia.org/wiki/Fitoterapie\">fitoterapie</a> de la începutul secolului I e.n., fiind menționată în <a href=\"https://ro.wikipedia.org/wiki/Noul_Testament\">Noul Testament</a> (<a href=\"https://ro.wikipedia.org/wiki/Evanghelia_după_Ioan\">Ioan</a> 19:39 <em>Și a venit și Nicodim, cel care venise la El mai înainte noaptea, aducând ca la o sută de litre de amestec de smirnă și aloe....</em> ).<a href=\"https://ro.wikipedia.org/wiki/Aloe_vera#cite_note-2\">[2]</a> Totuși, nu este clar dacă termenul <em>aloe</em> descris în <a href=\"https://ro.wikipedia.org/wiki/Biblie\">Biblie</a> se referă la <em>A. vera</em>. Extractele de <em>A. vera</em> sunt folosite pe scară largă în <a href=\"https://ro.wikipedia.org/wiki/Cosmetică\">cosmetică</a> și <a href=\"https://ro.wikipedia.org/wiki/Medicină_alternativă\">medicina alternativă</a>, susținându-se că au proprietăți de reîntinerire, vindecare sau analgezice.<a href=\"https://ro.wikipedia.org/wiki/Aloe_vera#cite_note-FLA-3\">[3]</a><a href=\"https://ro.wikipedia.org/wiki/Aloe_vera#cite_note-MAL-4\">[4]</a><a href=\"https://ro.wikipedia.org/wiki/Aloe_vera#cite_note-AA-5\">[5]</a> Nu există, însă, dovezi științifice clare ale eficienței sau ale siguranței folosirii de extract de <em>A. vera</em> în scopuri cosmetice sau medicale, iar dovezile care apar sunt adesea contrazise de alte studii.<a href=\"https://ro.wikipedia.org/wiki/Aloe_vera#cite_note-Ernst-6\">[6]</a><a href=\"https://ro.wikipedia.org/wiki/Aloe_vera#cite_note-Marshall-7\">[7]</a><a href=\"https://ro.wikipedia.org/wiki/Aloe_vera#cite_note-Boudreau-8\">[8]</a><a href=\"https://ro.wikipedia.org/wiki/Aloe_vera#cite_note-Vogler-9\">[9]</a> Există doar câteva dovezi preliminare că extractele de <em>A. vera</em> ar putea fi utile în tratamentul <a href=\"https://ro.wikipedia.org/wiki/Diabet\">diabetului</a> și în cazul nivelului ridicat de lipide în organismul uman.<a href=\"https://ro.wikipedia.org/wiki/Aloe_vera#cite_note-Boudreau-8\">[8]</a> Aceste efecte pozitive par a se datora prezenței unor compuși cum ar fi <a href=\"https://ro.wikipedia.org/w/index.php?title=Manan&action=edit&redlink=1\">manan</a>, <a href=\"https://ro.wikipedia.org/wiki/Antrachinonă\">antrachinonă</a> și <a href=\"https://ro.wikipedia.org/wiki/Lectină\">lectine</a>.<a href=\"https://ro.wikipedia.org/wiki/Aloe_vera#cite_note-Boudreau-8\">[8]</a><a href=\"https://ro.wikipedia.org/wiki/Aloe_vera#cite_note-King-10\">[10]</a><a href=\"https://ro.wikipedia.org/wiki/Aloe_vera#cite_note-Eshun-11\">[11]</a></p>\r\n', '<p><em><strong>Aloe vera</strong></em> (<a href=\"https://en.wikipedia.org/wiki/Help:IPA_for_English\">/ˈæloʊiː/</a> or <a href=\"https://en.wikipedia.org/wiki/Help:IPA_for_English\">/ˈæloʊ/</a>) is a <a href=\"https://en.wikipedia.org/wiki/Succulent_plant\">plant</a> <a href=\"https://en.wikipedia.org/wiki/Species\">species</a> of the <a href=\"https://en.wikipedia.org/wiki/Genus\">genus</a> <em><a href=\"https://en.wikipedia.org/wiki/Aloe\">Aloe</a></em>. It grows wild in tropical climates around the world and is cultivated for agricultural and medicinal uses. Aloe is also used for decorative purposes and grows successfully indoors as a potted plant.<a href=\"https://en.wikipedia.org/wiki/Aloe_vera#cite_note-3\">[3]</a></p>\r\n\r\n<p>It is found in many consumer products including beverages, skin lotion, cosmetics, or ointments for minor burns and sunburns. There is little scientific evidence of the effectiveness or safety of <em>Aloe vera</em> extracts for either cosmetic or medicinal purposes. Studies finding positive evidence are frequently contradicted by other studies.<a href=\"https://en.wikipedia.org/wiki/Aloe_vera#cite_note-NTP-Boudreau-4\">[4]</a><a href=\"https://en.wikipedia.org/wiki/Aloe_vera#cite_note-Ernst-5\">[5]</a><a href=\"https://en.wikipedia.org/wiki/Aloe_vera#cite_note-Marshall-6\">[6]</a></p>\r\n', '1501180428');
...
CREATE TABLE `web_hospitalizations` (
  `ID` int(11) NOT NULL,
  `CardCode` varchar(128) CHARACTER SET latin1 NOT NULL,
  `DoctorCode` varchar(32) COLLATE utf8_romanian_ci NOT NULL,
  `Hospital` int(11) NOT NULL,
  `Reason` varchar(256) CHARACTER SET latin1 NOT NULL,
  `StartDate` varchar(128) CHARACTER SET latin1 NOT NULL COMMENT 'timestamp',
  `StopDate` varchar(128) CHARACTER SET latin1 NOT NULL COMMENT 'timestamp'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_romanian_ci ROW_FORMAT=COMPACT;
...
INSERT INTO `web_hospitalizations` (`ID`, `CardCode`, `DoctorCode`, `Hospital`, `Reason`, `StartDate`, `StopDate`) VALUES
(1, '3276798432475544591', '3276798432475544', 5, '<p>Faringita</p>', '1432477237', '1495635638'),
(2, '3276798432475544591', '3276798432475544591', 1, '<p>Pneumonie</p>\r\n', '1501074540', '1501074866');
...
CREATE TABLE `web_medicatii` (
  `ID` int(11) NOT NULL,
  `DoctorCode` varchar(128) CHARACTER SET latin1 NOT NULL,
  `Product` varchar(256) CHARACTER SET latin1 NOT NULL,
  `Date` varchar(128) CHARACTER SET latin1 NOT NULL,
  `CardCode` varchar(128) CHARACTER SET latin1 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_romanian_ci ROW_FORMAT=COMPACT;
...
CREATE TABLE `web_notes` (
  `ID` int(11) NOT NULL,
  `CardCode` varchar(256) CHARACTER SET latin1 NOT NULL,
  `ByDoctor` varchar(256) CHARACTER SET latin1 NOT NULL COMMENT 'CardCode',
  `Notes` mediumtext CHARACTER SET latin1 NOT NULL,
  `Date` varchar(128) CHARACTER SET latin1 NOT NULL COMMENT 'TIMESTAMP'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_romanian_ci ROW_FORMAT=COMPACT;
